const Footer = () => {
  return (
    <footer className="text-white bg-gray-900 mt-10">
      <div className="container p-6 mx-auto">
        <div className="lg:flex gap-x-3">
          <div className="w-full lg:w-2/5 mx-auto ">
            <div className="px-6 md:m-auto lg:text-start text-center ">
              <div className="">
                <a
                  href="/"
                  className="text-2xl  font-serif font-bold text-green-600  hover:text-red-700 duration-200"
                >
                  Easy Learning
                </a>
              </div>
              ...
              <p className=" mt-2 text-gray-300  dark:text-gray-300 pr-5">
                Join 31,000+ users and never miss out on new courses.
              </p>

              <div className="flex lg:justify-start justify-center mt-6 -mx-2">
                <a
                  href="/"
                  className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-green-600 "
                  aria-label="Reddit"
                >
                  <svg
          ...
          <div className="mt-6 lg:mt-0 lg:flex-1">
            <div className="grid grid-cols-1 gap-6  md:grid-cols-4 lg:grid-cols-4">
              <div>
                <h3 className=" font-semibold text-lg text-green-600">About</h3>
                <a
                  href="/"
              ...
              <div>
                <h3 className="font-semibold text-lg text-green-600">Blog</h3>
                <a
                  href="/"
                  className="block mt-2 text-sm text-gray-300 hover:underline"
                >
              ...
              <div>
                <h3 className="font-semibold text-lg text-green-600">Books</h3>
                <a
                  href="/"
                  className="block mt-2 text-sm text-gray-300 hover:underline"
                >
        ...
        <div>
          <p className="text-center text-gray-300 dark:text-gray-300">
            © Easy Learning 2024 - All rights reserved
          </p>
        </div>
      </div>
    </footer>
