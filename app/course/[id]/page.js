...
const SingleCourse = async ({ params: { id } }) => {
  ...
  return (
    <div className="max-w-4xl lg:mx-auto mx-3 bg-white shadow-shadow1 md:p-5 p-2 rounded-md hover:shadow-shadow2 duration-300 flex md:flex-row flex-col gap-x-3 md:gap-y-0 gap-y-4 mt-5">
